...
(async () => {
  ...
  await getOfferedClassRepository().updateClasses(
    path.join(__dirname, "..", "classes.yaml")
  );
  ...
  // mapping vendor frontend paths
  app.use("/assets/vendor/bootstrap/css", express.static(path.join(requireIt.directory("bootstrap"), "dist", "css")));
  app.use("/assets/vendor/bootstrap/js", express.static(path.join(requireIt.directory("bootstrap"), "dist", "js")));
  app.use("/assets/vendor/jquery", express.static(path.join(requireIt.directory("jquery"), "dist")));
  app.use("/assets/vendor/popper.js", express.static(path.join(requireIt.directory("popper.js"), "dist")));
